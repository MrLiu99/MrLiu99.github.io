...
My research interests include **edge computing** and **heterogeneous multi-agent systems**, with a focus on computation offloading,  adaptive model routing and multi-objective optimization. I have published 10 papers in international journals and conferences, with <a href='https://scholar.google.com/citations?hl=en&user=2v307vU77j8C'><span id='total_cit'></span> Google Scholar citations 152</a> 
